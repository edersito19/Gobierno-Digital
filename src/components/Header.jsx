...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed w-full z-[997] px-5 bg-black shadow-md mx-auto flex justify-center">
        <div className="py-6 w-[1000px] flex items-center">
          ...
          <NavLink
            className="text-white text-lg font-bold lg:block hidden text-center"
            to="/"
          >
            <span>Pokédex</span>
          </NavLink>
